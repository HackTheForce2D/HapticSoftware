...
int main()
{
	...
	int boucleGraphique,tauxGraphique,tauxHaptique;
	sf::Clock horlogeGraphique, horlogeHaptique;
	//--------------------fenêtre graphique--------------------------------
    sf::RenderWindow window(sf::VideoMode(800, 700),"Haptics");
    ...
    textTauxGr.setPosition(20,20); textTauxGr.setFont(font); textTauxGr.setCharacterSize(18);
    textTauxHa.setPosition(20,35); textTauxHa.setFont(font); textTauxHa.setCharacterSize(18);
    textCoupleM1.setPosition(A.x-60,A.y); textCoupleM1.setFont(font);textCoupleM1.setCharacterSize(22);
    textCoupleM2.setPosition(E.x+60,E.y); textCoupleM2.setFont(font); textCoupleM2.setCharacterSize(22);
	//------------------------------------------------------------------
	sf::VertexArray pantograph(sf::LinesStrip, 5);
	//-----------------------------------------------------------------
	sf::Transform echelle;
	echelle.scale(4, 4, origine.x, origine.y);
	sf::Transform echelle_inverse(echelle.getInverse());
	sf::Transform box2sfml;
	box2sfml.translate(400, 300);
	box2sfml.scale(-20, -20);	
